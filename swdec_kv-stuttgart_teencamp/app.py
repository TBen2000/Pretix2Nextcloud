# Customized Pretix2Nextcloud instance for kv-stuttgart-teencamp
...
class Dataframe:
    ...
    def _get_debloated_df(self) -> pd.DataFrame:
        ...
        # combine "Wo geht Ihr Kind in den Teenkreis?" and "Wir melden uns über folgenden Ort an" and "Wir melden uns über folgenden Ort an (#2)" to "Ort"
        col1 = "Wo geht Ihr Kind in den Teenkreis?"
